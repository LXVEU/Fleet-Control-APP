...
export default function MaintenanceAddPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ─── УБРАНА ПРОВЕРКА ПРОБЕГА ДЛЯ ТО ───
      ...
      setSuccess(true)
      setFormData({ vehicleId: '', meterValue: '', description: '', cost: '' })
      setLastMileage(null)
          ...
          <>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ fontSize: 14, color: '#94a3b8', marginTop: 4, textAlign: 'center' }}>
                Введите данные о техническом обслуживании
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Последний пробег - только для информации */}
              {formData.vehicleId && (
                <div style={{
                  padding: '12px 16px',
                  borderRadius: 12,
                  ...
                  <span style={{ fontSize: 13, color: '#64748b' }}>
                    {loadingLastMileage ? 'Загрузка...' : 'Последний пробег (информационно)'}
                  </span>
                  <span style={{ 
                    fontSize: 15, 
                    fontWeight: 700, 
              ...
              <div style={{ marginBottom: 16 }}>
                <label style={{ 
                  ...
                  Пробег на момент ТО <span style={{ color: '#dc2626' }}>*</span>
                </label>
                <input
                  type="number"
